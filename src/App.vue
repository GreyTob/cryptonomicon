...
<script>
import { loadTickers, loadTickerList } from "./api";
...
export default {
  ...
  mounted() {
    setTimeout(async () => {
      const firstLoadData = await loadTickerList();

      this.coinsList = Object.values(firstLoadData.Data);
    }, 0);
  },
  ...
  watch: {
    ...
    paginatedTickers() {
      if (this.paginatedTickers.lenth === 0 && this.page > 1) {
        this.page -= 1;
      }
    },
